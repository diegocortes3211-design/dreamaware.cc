...
export default function FlowApp() {
  ...
  const [cursorPull, setCursorPull] = useState(0.2);
...
const S: Record<string, React.CSSProperties> = {
  wrap: {
    ...
    bottom: 0,
    background:
      "radial-gradient(1200px 800px at 50% 50%, rgba(16,16,32,0.8), rgba(0,0,0,1))",
    overflow: "hidden",
    userSelect: "none",
  },
  canvas: {
